...
Empieza por **[Inicio con Python](inicio-python.md)** (cuaderno de preparación para las prácticas). El resto de cuadernos está en [Cuadernos Colab](cuadernos.md) y junto a la teoría de cada apartado. Ábrelos en tu Drive antes de ejecutar.
...
| [Modelado](modelado.md) | **a)** | Diagramas, grafos, árboles |
...
| [Entorno Docker](docker.md) | apoyo / **f)** | Chuleta Docker, arquitectura HDFS/YARN, guion práctico y actividad del clúster Hadoop |
| [Cuadernos Colab](cuadernos.md) | prácticas | Cuadernos de la unidad (alumnado y solución de profesorado) |
| [Autoevaluación](autoevaluacion.md) | — | 20 preguntas de la unidad (no puntúa en Moodle) |

## Contenidos y criterios de evaluación

La siguiente tabla relaciona los contenidos con los criterios de evaluación (CE).

| Contenido | CE | Dónde lo trabajas aquí |
| --- | --- | --- |
...
| Técnicas de análisis de datos en Big Data | **a)**–**g)** | [Inicio con Python](inicio-python.md), [1.1](ciclo-analisis.md), [1.2](fundamentos.md), [modelado](modelado.md), [tiempo real](tiempo-real.md), [costes](costes-calidad.md) |
...
| Preproceso de datos | **b)** / **d)** | [1.4](preproceso.md) |
...
!!! info "Frontera con BDA"
    El diseño del lago y Pentaho se quedan en BDA. El [marco Big Data](marco-big-data.md) proporciona el vocabulario necesario para analizar los datos. Aquí la evidencia es **código, consulta y justificación**, no un `.ktr`.
