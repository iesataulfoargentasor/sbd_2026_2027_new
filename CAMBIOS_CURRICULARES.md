...
La siguiente tabla relaciona los contenidos con sus criterios de evaluación.
...
| Técnicas de análisis de datos en Big Data | a, b | `docs/ut1/inicio-python.md`, 1.1, 1.2 y `docs/ut1/cuadernos.md` |
...
| Preproceso | b, d | `docs/ut1/preproceso.md` |
...
| Cuadernos Colab de la unidad | prácticas | `docs/ut1/cuadernos.md` (y enlaces en cada apartado) |

## Decisiones didácticas

- Estilo y tema copiados del sitio de BDA (Material, paleta del centro, motor de test).
- Frontera: BDA diseña el almacén y PDI; SBD ejecuta pandas, API, SQL Athena y justifica coste/calidad. El apartado 1.0 proporciona el marco conceptual para el análisis.
- Manual Docker: chuleta + actividad Hadoop + vídeo (ZIP de Moodle no entra en git).
- Contenidos complementarios: modelado, tiempo real, costes/calidad y proyecto integrador.
